...
public class RecommenderEvaluation {
  ...
  public RecommenderEvaluation(RecommenderConfiguration configuration, EvaluationReport report) {
    checkArgument(configuration != null, "The description must not be null.");
  ...
  public String toString() {
    ...
    return configuration + ". Evaluation result: mae= " + mae + ", rmse=" + rmse + ", coverage="
        + Math.round(evaluationReport.getCoverage() * 100) + ", duration="
        + evaluationReport.getDuration() + ".";
  }
}
