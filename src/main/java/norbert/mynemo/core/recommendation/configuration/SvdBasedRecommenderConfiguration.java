 ...
 */
public class SvdBasedRecommenderConfiguration implements
	...
	public SvdBasedRecommenderConfiguration(RecommenderType type,
			int numberOfFeatures, int numberOfIterations) {
		this.type = type;
	...
	public String toString() {
		return type.toString() + " with " + featureNumber + " features and "
				+ iteractionNumber + " iterations";
	}
}
