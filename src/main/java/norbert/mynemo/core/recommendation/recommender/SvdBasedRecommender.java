 ...
 * based on the SVD method. A builder is chosen via the constructors.
 */
public class SvdBasedRecommender implements RecommenderBuilder {
	...
	public Recommender buildRecommender(DataModel dataModel)
		...
		case SVD_WITH_ALSWR_FACTORIZER:
			factorizer = new ALSWRFactorizer(dataModel, featuresNumber,
					DEFAULT_LAMBDA, iterationsNumber);
			break;

		case SVD_WITH_PARALLEL_SGD_FACTORIZER:
			factorizer = new ParallelSGDFactorizer(dataModel, featuresNumber,
					DEFAULT_LAMBDA, DEFAULT_EPOCHS);
			break;

		case SVD_WITH_RATING_SGD_FACTORIZER:
			factorizer = new RatingSGDFactorizer(dataModel, featuresNumber,
					iterationsNumber);
			break;

		case SVD_WITH_SVDPLUSPLUS_FACTORIZER:
			factorizer = new SVDPlusPlusFactorizer(dataModel, featuresNumber,
					iterationsNumber);
			break;
