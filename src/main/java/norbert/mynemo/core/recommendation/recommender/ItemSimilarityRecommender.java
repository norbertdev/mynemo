 ...
 * based on similarities between the items. A recommender is chosen via the
 * {@link #ItemSimilarityRecommender(ItemBasedRecommenderConfiguration)
 * constructor}.
 */
public class ItemSimilarityRecommender implements RecommenderBuilder {
	...
	public Recommender buildRecommender(DataModel dataModel)
		...
		int cacheSize = Math.min(
				dataModel.getNumItems() * dataModel.getNumItems(),
				MAXIMUM_CACHE_SIZE);
