...
/**
 * <p>
 * This filter writes only the ratings on the movies that have at least a given
 * number of ratings.
 * </p>
 * <p>
 * The ratings are kept in memory until the {@link #close()} method is called.
 * Then, the ratings are written to the next writer.
 * </p>
 */
public class MinRatingByMovieFilter implements RatingWriter {

	/**
	 * All ratings by movie. Every rating that is given to the
	 * {@link #write(MynemoRating) write} method is kept in this map. The key is
	...
	public MinRatingByMovieFilter(RatingWriter nextWriter, int minRatingByMovie) {
		...
		checkArgument(0 < minRatingByMovie, "The minimum rating movie must be"
				+ " at least 1.");
	...
	public void close() throws IOException {
		for (Entry<String, Collection<MynemoRating>> entry : allRatings
				.entrySet()) {
