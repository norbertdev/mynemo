...
public class FileImporter {
   ...
   * rating files, a movie file must be provided.
   *
   * <p>
  ...
  public static void convert(String outputFilepath, Collection<String> inputFilepaths,
      Optional<String> movieFilepath, Optional<String> user, Optional<Integer> maxUsers,
    ...
    checkArgument(!movieFilepath.isPresent() || new File(movieFilepath.get()).exists(), "The movie"
        + " file is not found.");
  ...
  private static ImportableRatingFile getFile(String ratingFilepath,
      Optional<String> movieFilepath, Optional<String> user) throws IOException {
